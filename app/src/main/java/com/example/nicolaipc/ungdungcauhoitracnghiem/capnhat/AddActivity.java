...
public class AddActivity extends AppCompatActivity {
    ...
    private void insert() {
        ...
        database.insert("tracnghiem", null, contentValues );
    ...
    public void LoadDapAn() {
        ...
        spin.setOnItemSelectedListener(new AddActivity.MyProcessEvent());
    }
    ...
    public void LoadDe() {
        ...
        //thiết lập sự kiện chọn phần tử cho Spinner
        spin2.setOnItemSelectedListener(new AddActivity.MyProcessEvent1());
    }
    ...
    public void LoadMonHoc() {
        ...
        spin2.setAdapter(adapter);
        //thiết lập sự kiện chọn phần tử cho Spinner
        spin2.setOnItemSelectedListener(new AddActivity.MyProcessEvent3());
    }
