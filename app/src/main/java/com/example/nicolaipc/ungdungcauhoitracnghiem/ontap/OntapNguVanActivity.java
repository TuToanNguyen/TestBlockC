...
import com.example.nicolaipc.ungdungcauhoitracnghiem.capnhat.AdapterTracNghiem;
...
public class OntapNguVanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ontap_ngu_van);
